...
# 1.读取本地中文文本文件
text = open('C:\\Users\\20714\\Desktop\\1.txt', encoding='gbk').read()
...
wc = WordCloud(font_path='C:\\Users\\20714\\Desktop\\yahei.ttf', width=600, height=400,
...
plt.show()  # 在IDE中显示图片
# 6.将生成的词云图保存在本地
wc.to_file('C:\\Users\\20714\\Desktop\\workcloud.png')
